...
function isMobile(h: Awaited<ReturnType<typeof headers>>) {
  const ua = h.get("user-agent") || "";
  const chMobile = h.get("sec-ch-ua-mobile");
  if (/Googlebot|Lighthouse|bot|crawl/i.test(ua)) return false;
  return chMobile === "?1" || /Mobi|Android|iPhone/i.test(ua);
}
